...
<section class="relative min-h-screen flex items-center overflow-hidden">
  ...
  <div class="relative z-10 container mx-auto px-4 text-center text-white">
    ...
    <!-- Modern Search Widget with Google Places Autocomplete -->
        ...
        <div class="grid grid-cols-1 lg:grid-cols-4 gap-4">
          <div class="lg:col-span-1 relative">
            ...
            <input id="from" name="from" type="text" autocomplete="off"
              class="places-autocomplete block w-full bg-white/10 border-white/20 text-white placeholder-white/60 focus:border-golden-400 focus:ring-golden-400 rounded-lg px-4 py-3"
          ...
          <div class="lg:col-span-1">
            ...
            <input id="date" name="date" type="date" min="{{ date('Y-m-d') }}"
              class="block w-full bg-white/10 border-white/20 text-white focus:border-golden-400 focus:ring-golden-400 rounded-lg px-4 py-3" />
          </div>
          <div class="lg:col-span-1 flex items-end">
            <button type="submit" class="w-full btn-accent text-lg font-bold py-4 hover:scale-105 transform transition-all duration-200">
              🔍 Buscar Viajes
            </button>
          </div>
        </div>
